...
project where you added `volto-addons-forest` to `mrs.developer.json`
...
This will build and start with Docker a clean `Plone backend` and `Volto Frontend` with `volto-addons-forest` block installed.
